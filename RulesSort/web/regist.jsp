...
<div class="uk-block uk-block-large uk-block-primary">
    <div class="uk-vertical-align uk-text-center">
        <div class="uk-vertical-align-middle" width="250px">
            <img class="uk-margin-bottom uk-animation-shake uk-animation-hover" width="120" height="100"
                 src="./img/7.png">
            <form id="regist" class="uk-form uk-panel uk-panel-box">
                ...
                <div class="uk-form-row">
                    <a onclick="regist_submit();" class="uk-width-1-1 uk-button uk-button-danger uk-button-large"
                       id="submit">注册</a>
                </div>
            </form>
        </div>
