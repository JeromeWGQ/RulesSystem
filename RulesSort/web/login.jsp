...
<div class="uk-block uk-block-large uk-block-primary">
    <div class="uk-vertical-align uk-text-center">
        <div class="uk-vertical-align-middle" width="250px">
            <img class="uk-margin-bottom uk-animation-shake uk-animation-hover" width="144" height="120"
                 src="./img/22.png">
            <form id="login" class="uk-form uk-panel uk-panel-box">
                ...
                <div class="uk-form-row">
                    <a class="uk-width-1-1 uk-button uk-button-danger uk-button-large" onclick="login_submit();"
                       id="submit">登录</a>
                </div>
